...
insert into airline(airline_id, name, address) values ('1', 'Air Serbia', '-');
insert into airline(airline_id, name, address) values ('2', 'Aegan Airlines', 'opis');
...
INSERT INTO car(car_type, id, description, model_name,model_number,number_of_cases,number_of_doors,number_of_seats,price_per_day,branch_office_id,reserved) values('Prestige_Cars','1','','Porsche911','1','1','2','2','80','1',true);
INSERT INTO car(car_type,id,description,model_name,model_number,number_of_cases,number_of_doors,number_of_seats,price_per_day,branch_office_id,reserved) values('Full_Size','2','','Ford Taurus','4','4','2','2','30','2',false);
...
INSERT INTO reservation_rentacar(reservation_id, car_type, drop_of_date, drop_of_loc, passengers, pick_up_date, pick_up_loc, car_id, servis_id) VALUES('1','Prestige_Cars','2019-02-22 12:00','1Mileve Maric','1','2019-02-19 12:00','1Mileve Maric','1','1');
