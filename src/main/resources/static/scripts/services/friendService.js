...
app.factory('friendService', function($http) {
    ...
    var friends = function(id) {    
     	return $http.get("/friend/get/friends/" + id).then(function(response) {
             return response.data;
         });
     }
     var nonFriends = function(id) {    
     	return $http.get("/friend/get/non/friends/" + id).then(function(response) {
             return response.data;
         });
     }
     var pending = function(id) {    
      	return $http.get("/friend/get/pending/requests/" + id).then(function(response) {
              return response.data;
          });
      }
